...
# ANSI escape code for dark purple (color 91 in the 256-color palette)
...
sleep(2)
print("")
print(color.MAGENTA+"[1] Using CloudFlare")
sleep(0.1)
print("")
print(color.MAGENTA+"[2] Http Methodes ")
sleep(0.1)
print("")
print(color.MAGENTA+"[3] Inscure Http Header")
sleep(0.1)
print("")
print(color.MAGENTA+"[4] Directory Finder ")
sleep(0.1)
print("")
print(color.MAGENTA+"[5] To Finder Server WebSite")
sleep(0.1)
print("")
print(color.MAGENTA+"[6] WAF")
sleep(0.1)
print("")
print(color.MAGENTA+"[7] Parse Url")
sleep(0.1)
print("")
print(color.MAGENTA+"[8] LOGOUT")
sleep(0.1)
print("")

number= input(color.RED+"--Enter Number >>> ")
sleep(0.2)
print("")
